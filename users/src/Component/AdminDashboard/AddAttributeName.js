...
const AddAttributeName = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("http://54.177.55.202:4003/api/attribute", {
        method: "POST",
        mode: "cors",
        body: formData,
      });
...
<div class="col-md-10">
<input type="description" class="form-control"  onChange={(event) => setAttribute(event.target.value)}  style={{marginBottom:"16px;", height:"100px;"}}/>
</div>

</div>
<div class="row">
<div class="col-md-2"></div>
<div class="col-md-10"><br/><button type="button" class="btn btn-success ab1"  onClick={() => {handleSubmit();}}  style={{backgroundColor:"#DD3333",border:"1px solid #DD3333"}}>Submit</button></div>
</div>
</form>
