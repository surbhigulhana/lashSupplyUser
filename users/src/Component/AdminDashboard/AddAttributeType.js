...
const AddAttributeType = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("http://54.177.55.202:4003/api/Type", {
        method: "POST",
        mode: "cors",
        body: formData,
      });
      ...
      setAttribute("");
      setAttributeType("");
      fetch("http://54.177.55.202:4003/Type").then((result) => {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Add Attribute Types</h1>
  
</div>
<form>
<div class="row">
<div class="col-md-2" style={{marginTop:"7px;"}}>Attribute Name </div>
<div class="col-md-10"><div class="input-group mb-3">

<select class="custom-select" id="inputGroupSelect01"  value={AttributeName}
          onChange={(e) => {
            setAttribute(e.target.value);
          }}>
<option selected>Select Attribute </option>
{Aname.map((item) => (
            <option value={item.AttributeName}>{item.AttributeName}</option>
          ))}
...
<div class="row">
<div class="col-md-2">Attribute type</div>


<div class="col-md-10">
<input type="description" class="form-control"  onChange={(e) => {
...
<div class="col-md-10">
    <br/><button type="button" class="btn btn-success ab1" style={{backgroundColor:"#DD3333",border:"1px solid #DD3333"}} onClick={() => {handleSubmit();}}>Submit</button></div>
</div>
</form>
