...
const ShowUser = () => {
  ...
  const getUser = async () => {
    let result = await fetch("http://18.183.38.142:4003/Blocked");
            ...
            <div id="content">
              ...
              <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 class="h3 mb-0 text-gray-800">Restricted Users</h1>
                </div>
                <Table
                  striped
                  bordered
                    ...
                    {data && data
                      ...
                      .map((item, index) => (
                        <tr key={item._id}>
                          ...
                          <td data-label="Email" style={{color:"#DD3333"}}>{item.Status}</td>
