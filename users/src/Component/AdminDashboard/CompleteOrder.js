...
const CompleteOrder = () => {
    ...
    const getUser = async () => {
      let result = await fetch("http://54.177.55.202:4003/order");
  ...
  const CompleteOrder = async () => {
    let result = await fetch("http://54.177.55.202:4003/completeOrder");
    result = await result.json();
    setComplete(result);
  };
  useEffect(() => {
  ...
  async function editData() {
    ...
    let result = await fetch(`http://54.177.55.202:4003/order/${id}`, {
      method: "put",
      headers: {
  ...
  const handleClick = async (item) => {
    const response = await fetch(
      "http://54.177.55.202:4003/MoreOrder/" + item.UserName
    );
    const data1 = await response.json();
    setPictureList(data1);
    history("/OrderDetails", { state: data1 });
  };
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="dropdown show">
                          ...
                          >
                            <a class="dropdown-item" href="/Orderp">
                              Pending order
                            </a>
                            <a class="dropdown-item" href="/Orderc">
                              Completed order
                            </a>
                          ...
                          <tr key={item._id}>
                            ...
                            <td><button
                              ...
                              <button
                                type="button"
                                class="btn btn-primary ab1"
                                onClick={() => handleClick(item)}  style={{"backgroundColor":"#DD3333",color:"white",border:"none"}}
                              >
                                View More
                              </button>
