...
const Inquiry = () => {
  ...
  const getUser = async () => {
    let result = await fetch("http://54.177.55.202:4003/Inquiry");
  ...
  async function deleteData(id) {
    let result = await fetch(`http://54.177.55.202:4003/Inquiry/${id}`, {
      method: "delete",
    });
    let data = await result.json();
    console.log(data);
    fetch("http://54.177.55.202:4003/Inquiry").then((result) => {
