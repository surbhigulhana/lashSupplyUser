...
const Inquiry = () => {
  ...
  const getUser = async () => {
    let result = await fetch("http://35.77.222.89:4003/Inquiry");
  ...
  async function deleteData(id) {
    let result = await fetch(`http://35.77.222.89:4003/Inquiry/${id}`, {
      method: "delete",
    });
    let data = await result.json();
    console.log(data);
    fetch("http://35.77.222.89:4003/Inquiry").then((result) => {
