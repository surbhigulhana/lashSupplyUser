...
const Product = () => {
  ...
  const handleClick = async (item) => {
    const response = await fetch("http://54.177.55.202:4003/MoreData/" + item.Name);
  ...
  const getUser = async () => {
    let result = await fetch("http://54.177.55.202:4003/productData");
  ...
  async function deleteData(id) {
    let result = await fetch(`http://54.177.55.202:4003/productData/${id}`, {
      method: "delete",
    });
    let data = await result.json();
    console.log(data);
    fetch("http://54.177.55.202:4003/ProductData").then((result) => {
...
const [Pdata, setPData] = useState([]);
  useEffect(() => {
    fetch("http://54.177.55.202:4003/product").then((result) => {
      result.json().then((resp) => {
        setPData(resp);
      });
    });
  ...
  useEffect(() => {
    fetch("http://54.177.55.202:4003/category").then((result) => {
      result.json().then((resp) => {
        setCData(resp);
      });
    });
  ...
  useEffect(() => {
    fetch("http://54.177.55.202:4003/attribute").then((result) => {
      result.json().then((resp) => {
  ...
  async function filter(id){
    let result = await fetch(`http://54.177.55.202:4003/display/${id}`)
    let data = await result.json();
    setType1(data);
              ...
              <div class="container-fluid">
                          ...
                          <tr key={item._id}>
                            ...
                            <td data-label="Action">
                              ...
                              >
                                ...
                                <Modal size="xl"   show={editShow} onHide={editHandleClose} >
                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      <select
                          ...
                          id="inputGroupSelect01"
                          value={AttributeName}
                         onChange={(e)=>{filter(e.target.value);setAttributename(e.target.value)}}
                        >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        <select class="custom-select" id="inputGroupSelect01"  value={AttributeType}
                          onChange={(e) => {
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      {pictureList.map((item, index) => (
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                              <div class="card" style={{ border: "none" }}>
                                <img
                                  ...
                                  controls
                                  src={
                                    "http://54.177.55.202:4003/uploads/" +
                                    item.filename
                                  }
                                />
                               
                                <div class="card-body">
                                  <p class="card-title" style={{textAlign:"justify"}}>{item.Desc}</p>
                                  <h6 class="card-subtitle mb-2 text-muted">
                                    {item.AttributeName1} : {item.AttributeType1}
                                  </h6>
                                  <br/>
                                  <h6 class="card-subtitle mb-2 text-muted">
                                    {item.AttributeName2} : {item.AttributeType2}
                                  </h6>
                                  <p class="card-text">
                        ...
                        //       controls
                        //       src={
                        //         "http://54.177.55.202:4003/uploads/" + item.filename
                        //       }
                        //     />
                        //     <i
                        //       class="fa fa-circle"
