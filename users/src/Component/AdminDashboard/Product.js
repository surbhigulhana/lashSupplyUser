...
const Product = () => {
  ...
  const handleClick = async (item) => {
    const response = await fetch("http://18.183.38.142:4003/MoreData/" + item.Name);
  ...
  const getUser = async () => {
    let result = await fetch("http://18.183.38.142:4003/productData");
  ...
  async function deleteData(id) {
    let result = await fetch(`http://18.183.38.142:4003/productData/${id}`, {
      method: "delete",
    });
    let data = await result.json();
    console.log(data);
    fetch("http://18.183.38.142:4003/ProductData").then((result) => {
  ...
  useEffect(() => {
    fetch("http://18.183.38.142:4003/product").then((result) => {
      result.json().then((resp) => {
        setPData(resp);
      });
    });
  ...
  useEffect(() => {
    fetch("http://18.183.38.142:4003/category").then((result) => {
      result.json().then((resp) => {
        setCData(resp);
      });
    });
  ...
  async function filter(id) {
    let result = await fetch(`http://18.183.38.142:4003/display/${id}`);
    let data = await result.json();
    setType1(data);
  }
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      {pictureList.map((item, index) => (
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                              <div class="card" style={{ border: "none" }}>
                                <img
                                  ...
                                  controls
                                  src={
                                    "http://18.183.38.142:4003/uploads/" +
                                    item.filename
                                  }
                                />
                        ...
                        //       controls
                        //       src={
                        //         "http://18.183.38.142:4003/uploads/" + item.filename
                        //       }
                        //     />
                        //     <i
                        //       class="fa fa-circle"
