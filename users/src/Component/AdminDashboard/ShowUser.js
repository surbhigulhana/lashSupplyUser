...
const ShowUser = () => {
  ...
  const getUser = async () => {
    let result = await fetch("http://35.77.222.89:4003/getuser");
  ...
  async function deleteData(id) {
    let result = await fetch(`http://35.77.222.89:4003/deleteUser/${id}`, {
      method: "delete",
    });
    let data = await result.json();
    console.log(data);
    fetch("http://35.77.222.89:4003/getuser").then((result) => {
...
const [id, setId] = useState("");
  ...
  async function editData() {
    ...
    let result = await fetch(`http://35.77.222.89:4003/user/${id}`, {
      method: "put",
      headers: {
