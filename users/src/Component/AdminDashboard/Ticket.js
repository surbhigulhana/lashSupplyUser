...
const Ticket = () => {
  ...
  const getUser = async () => {
    let result = await fetch("http://54.177.55.202:4003/ticket");
  ...
  async function editData() {
    ...
    let result = await fetch(`http://54.177.55.202:4003/ticket/${id}`, {
      method: "put",
      headers: {
...
<Table id="example"  striped
        ...
        <thead>
            ...
            <tr>  
            <th class="bl5" width="13%">#</th>
            <th class="bl5" width="13%">Ticket Number</th>
                <th class="bl5" width="20%">Username</th>
                <th class="bl5" width="20%">User email</th>
                  <th class="bl5" width="12%">Phone</th>
                    <th class="bl5" width="20%">Issue raised</th>
                     <th class="bl5" width="15%">Status</th>
                      ...
                      data
                        .filter((val) => {
                          if (search == "") {
                            ...
                            val.Tnumber.toLowerCase().includes(
                              search.toLowerCase()
                            )
                          ) {
                            return val;
                        ...
                        .map((item, index) => (
                          <tr key={item._id}>
                            ...
                            <td data-label="firstName">{item.Tnumber}</td>
                            <td data-label="LastName">{item.UserName}</td>
                            <td data-label="Phone">{item.UserEmail}</td>
                            <td data-label="Email">{item.Phone}</td>
                            <td data-label="Email">{item.Issue}</td>
                            ...
                            <Modal show={editShow} onHide={handleClose}>
                              ...
                              <Modal.Body>
                                ...
                                >
                                  ...
                                  <option value="Issue On Process">Issue On Process</option>
                                </select>
                              </Modal.Body>
                              <Modal.Footer>
                                <Button
